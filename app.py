...
{{
  ...
  "stop_loss": <stop loss price — below key support for BUY, above resistance for SELL>,
  ...
  "rr1": <risk/reward ratio for TP1, 1 decimal>,
  "rr2": <risk/reward ratio for TP2, 1 decimal>,
  "rr3": <risk/reward ratio for TP3, 1 decimal>,
